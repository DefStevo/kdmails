...
#Region "Funktionen"
    ...
    Function ConnectDB() As Boolean
        ...
        Catch ex As Exception
            frmHaupt.stStatus.Text = "Keine Verbindung zur Datenbank " & _strDB & "@" & _strServer
            MsgBox("Fehler: " & ex.Message & vbCrLf & vbCrLf & _
        ...
        frmHaupt.stStatus.Text = "Verbunden mit Datenbank " & _strDB & "@" & _strServer
        _bConnStatus = True
        Return True
    End Function
