...
#Region "Funktionen"
    Function InitConfig(ByVal Ordner As Boolean, ByVal Domänen As Boolean) As Boolean
        If Ordner = True Then
            ...
            '_swOrdner = New System.IO.StreamWriter(_strFileOrdner)
        End If
        ...
        If Domänen = True Then
            ...
            End If
            '_swDomäne = New System.IO.StreamWriter(_strFileDomäne)
        End If
...
#Region "Datei Funktionen"
    ...
    Function WriteConfigDomain() As Boolean
        ...
        For i As Integer = 0 To oDomänenL.Count - 1
            If Not oDomänenL(i).strOrdner.strName = "KEIN" Then
                strBuffer = strBuffer & _
